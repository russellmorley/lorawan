...
namespace LoraDeviceManager.FunctionBundler
{
    ...
    public class PreferredGatewayExecutionItem : IFunctionBundlerExecutionItem
    {
        ...
        public PreferredGatewayExecutionItem(
            ICacheStore cacheStore,
            ILogger<PreferredGatewayExecutionItem> log,
            IConfiguration configuration)
        {
            ...
            {
                receiveInterval = receiveIntervalSettingInt;
            }
            else
            {
                receiveInterval = DefaultReceiveRequestsPeriodInMs;
            }

            this.log.LogInformation("Using receive interval for in preferred gateway of {interval}ms", receiveInterval);
        }
