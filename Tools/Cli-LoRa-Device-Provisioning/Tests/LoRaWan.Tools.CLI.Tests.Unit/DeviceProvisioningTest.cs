...
namespace LoRaWan.Tools.CLI.Tests.Unit
{
    ...
    public class DeviceProvisioningTest
    {
        ...
        private const string IotEdgeVersion = "1.5";
                ...
                string lnsHostAddress = "ws://mylns:5000")
        {
            ...
            const string deviceManagerServicesUrl = "https://myfunc.azurewebsites.com/api";
            const string deviceManagerServicesCode = "secret-code";
            ...
            // Act
            var args = CreateArgs($"add-gateway --reset-pin {resetPin} --device-id {deviceId} --spi-dev {spiDev} --spi-speed {spiSpeed} --devicemanagerservices-url {deviceManagerServicesUrl} --devicemanagerservices-code {deviceManagerServicesCode} --lns-host-address {lnsHostAddress} --network {networkId} --lora-version {LoRaVersion} --tenant-id {TenantId}");
            var actual = await Program.Run(args, this.configurationHelper);
            ...
            var expectedConfigurationJson = $"{{\"modulesContent\":{{\"$edgeAgent\":{{\"properties.desired\":{{\"schemaVersion\":\"1.0\",\"runtime\":{{\"type\":\"docker\",\"settings\":{{\"loggingOptions\":\"\",\"minDockerVersion\":\"v1.25\"}}}},\"systemModules\":{{\"edgeAgent\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"mcr.microsoft.com/azureiotedge-agent:{IotEdgeVersion}\",\"createOptions\":\"{{}}\"}}}},\"edgeHub\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"mcr.microsoft.com/azureiotedge-hub:{IotEdgeVersion}\",\"createOptions\":\"{{ \\\"HostConfig\\\": {{   \\\"PortBindings\\\": {{\\\"8883/tcp\\\": [  {{\\\"HostPort\\\": \\\"8883\\\" }}  ], \\\"443/tcp\\\": [ {{ \\\"HostPort\\\": \\\"443\\\" }} ], \\\"5671/tcp\\\": [ {{ \\\"HostPort\\\": \\\"5671\\\"  }}] }} }}}}\"}},\"env\":{{\"OptimizeForPerformance\":{{\"value\":\"false\"}},\"mqttSettings__enabled\":{{\"value\":\"false\"}},\"AuthenticationMode\":{{\"value\":\"CloudAndScope\"}},\"NestedEdgeEnabled\":{{\"value\":\"false\"}}}},\"status\":\"running\",\"restartPolicy\":\"always\"}}}},\"modules\":{{\"LoRaWanNetworkSrvModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"russellgm/lorawannetworksrvmodule:{LoRaVersion}\",\"createOptions\":\"{{\\\"ExposedPorts\\\": {{ \\\"5000/tcp\\\": {{}}}}, \\\"HostConfig\\\": {{  \\\"PortBindings\\\": {{\\\"5000/tcp\\\": [  {{ \\\"HostPort\\\": \\\"5000\\\", \\\"HostIp\\\":\\\"172.17.0.1\\\" }} ]}}}}}}\"}},\"version\":\"1.0\",\"env\":{{\"ENABLE_GATEWAY\":{{\"value\":\"true\"}},\"LOG_LEVEL\":{{\"value\":\"2\"}}}},\"status\":\"running\",\"restartPolicy\":\"always\"}},\"universaldecodermodule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"docker.io/russellgm/universaldecoder:1.0-arm64\",\"createOptions\":\"{{}}\"}},\"version\":\"1.0\",\"status\":\"running\",\"restartPolicy\":\"always\"}},\"LoRaBasicsStationModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"loraedge/lorabasicsstationmodule:{LoRaVersion}\",\"createOptions\":\"  {{\\\"HostConfig\\\": {{\\\"NetworkMode\\\": \\\"host\\\", \\\"Privileged\\\": true }},  \\\"NetworkingConfig\\\": {{\\\"EndpointsConfig\\\": {{\\\"host\\\": {{}} }}}}}}\"}},\"env\":{{\"RESET_PIN\":{{\"value\":\"{resetPin}\"}},\"TC_URI\":{{\"value\":\"ws://172.17.0.1:5000\"}},\"SPI_DEV\":{{\"value\":\"{spiDev}\"}},\"SPI_SPEED\":{{\"value\":\"{spiSpeed}\"}}}},\"version\":\"1.0\",\"status\":\"running\",\"restartPolicy\":\"always\"}}}}}}}},\"$edgeHub\":{{\"properties.desired\":{{\"schemaVersion\":\"1.0\",\"routes\":{{\"route\":\"FROM /* INTO $upstream\"}},\"storeAndForwardConfiguration\":{{\"timeToLiveSecs\":7200}}}}}},\"LoRaWanNetworkSrvModule\":{{\"properties.desired\":{{\"DeviceManagerServicesUrl\":\"{deviceManagerServicesUrl}\",\"DeviceManagerServicesCode\":\"{deviceManagerServicesCode}\",\"hostAddress\":\"{lnsHostAddress}\",\"network\":\"{networkId}\",\"tenantid\":\"{TenantId}\"}}}}}},\"moduleContent\":{{}},\"deviceContent\":{{}}}}";
        ...
        public async Task DeployEdgeDeviceWithLocalRedisContainer()
        {
            ...
            var actualConfigurationJson = JsonConvert.SerializeObject(actualConfiguration);
            var expectedConfigurationJson = $"{{\"modulesContent\":{{\"$edgeAgent\":{{\"properties.desired\":{{\"schemaVersion\":\"1.0\",\"runtime\":{{\"type\":\"docker\",\"settings\":{{\"loggingOptions\":\"\",\"minDockerVersion\":\"v1.25\"}}}},\"systemModules\":{{\"edgeAgent\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"mcr.microsoft.com/azureiotedge-agent:{IotEdgeVersion}\",\"createOptions\":\"{{}}\"}}}},\"edgeHub\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"mcr.microsoft.com/azureiotedge-hub:{IotEdgeVersion}\",\"createOptions\":\"{{ \\\"HostConfig\\\": {{   \\\"PortBindings\\\": {{\\\"8883/tcp\\\": [  {{\\\"HostPort\\\": \\\"8883\\\" }}  ], \\\"443/tcp\\\": [ {{ \\\"HostPort\\\": \\\"443\\\" }} ], \\\"5671/tcp\\\": [ {{ \\\"HostPort\\\": \\\"5671\\\"  }}] }} }}}}\"}},\"env\":{{\"OptimizeForPerformance\":{{\"value\":\"false\"}},\"mqttSettings__enabled\":{{\"value\":\"false\"}},\"AuthenticationMode\":{{\"value\":\"CloudAndScope\"}},\"NestedEdgeEnabled\":{{\"value\":\"false\"}}}},\"status\":\"running\",\"restartPolicy\":\"always\"}}}},\"modules\":{{\"LoRaWanNetworkSrvModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"russellgm/lorawannetworksrvmodule:{LoRaVersion}\",\"createOptions\":\"{{\\\"ExposedPorts\\\": {{ \\\"5000/tcp\\\": {{}}}}, \\\"HostConfig\\\": {{  \\\"PortBindings\\\": {{\\\"5000/tcp\\\": [  {{ \\\"HostPort\\\": \\\"5000\\\", \\\"HostIp\\\":\\\"172.17.0.1\\\" }} ]}}}}}}\"}},\"version\":\"1.0\",\"env\":{{\"ENABLE_GATEWAY\":{{\"value\":\"true\"}},\"LOG_LEVEL\":{{\"value\":\"2\"}},\"LOCAL_DEVICE_MANAGER_REDIS_CONNECTION_STRING\":{{\"value\":\"{localRedisConnectionString}\"}}}},\"status\":\"running\",\"restartPolicy\":\"always\"}},\"universaldecodermodule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"docker.io/russellgm/universaldecoder:1.0-arm64\",\"createOptions\":\"{{}}\"}},\"version\":\"1.0\",\"status\":\"running\",\"restartPolicy\":\"always\"}},\"CacheModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"{localRedisImageUrl}\",\"createOptions\":\"{{\\\"HostConfig\\\":{{\\\"NetworkMode\\\":\\\"host\\\",{localRedisLocalParamsEscapedJsonString}}}}}\"}},\"version\":\"1.0\",\"env\":{{}},\"status\":\"running\",\"restartPolicy\":\"always\"}},\"LoRaBasicsStationModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"loraedge/lorabasicsstationmodule:999.999.10\",\"createOptions\":\"  {{\\\"HostConfig\\\": {{\\\"NetworkMode\\\": \\\"host\\\", \\\"Privileged\\\": true }},  \\\"NetworkingConfig\\\": {{\\\"EndpointsConfig\\\": {{\\\"host\\\": {{}} }}}}}}\"}},\"env\":{{\"RESET_PIN\":{{\"value\":\"2\"}},\"TC_URI\":{{\"value\":\"ws://172.17.0.1:5000\"}},\"SPI_DEV\":{{\"value\":\"3\"}},\"SPI_SPEED\":{{\"value\":\"1\"}}}},\"version\":\"1.0\",\"status\":\"running\",\"restartPolicy\":\"always\"}}}}}}}},\"$edgeHub\":{{\"properties.desired\":{{\"schemaVersion\":\"1.0\",\"routes\":{{\"route\":\"FROM /* INTO $upstream\"}},\"storeAndForwardConfiguration\":{{\"timeToLiveSecs\":7200}}}}}},\"LoRaWanNetworkSrvModule\":{{\"properties.desired\":{{\"DeviceManagerServicesUrl\":\"https://myfunc.azurewebsites.com/api\",\"DeviceManagerServicesCode\":\"secret-code\",\"hostAddress\":\"ws://mylns:5000\",\"network\":\"quickstartnetwork\",\"tenantid\":\"12345\"}}}}}},\"moduleContent\":{{}},\"deviceContent\":{{}}}}";
            Assert.Equal(expectedConfigurationJson, actualConfigurationJson);
        }
        ...
        public async Task DeployEdgeDeviceWhenOmmitingSpiDevAndAndSpiSpeedSettingsAreNotSendToConfiguration()
        {
            ...
            // Act
            var args = CreateArgs($"add-gateway --reset-pin {resetPin} --device-id {deviceId}  --devicemanagerservices-url {deviceManagerServicesUrl} --devicemanagerservices-code {deviceManagerServicesCode} --lns-host-address {lnsHostAddress} --network {NetworkName} --lora-version {LoRaVersion}");
            var actual = await Program.Run(args, this.configurationHelper);
            ...
            var expectedConfigurationJson = $"{{\"modulesContent\":{{\"$edgeAgent\":{{\"properties.desired\":{{\"schemaVersion\":\"1.0\",\"runtime\":{{\"type\":\"docker\",\"settings\":{{\"loggingOptions\":\"\",\"minDockerVersion\":\"v1.25\"}}}},\"systemModules\":{{\"edgeAgent\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"mcr.microsoft.com/azureiotedge-agent:{IotEdgeVersion}\",\"createOptions\":\"{{}}\"}}}},\"edgeHub\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"mcr.microsoft.com/azureiotedge-hub:{IotEdgeVersion}\",\"createOptions\":\"{{ \\\"HostConfig\\\": {{   \\\"PortBindings\\\": {{\\\"8883/tcp\\\": [  {{\\\"HostPort\\\": \\\"8883\\\" }}  ], \\\"443/tcp\\\": [ {{ \\\"HostPort\\\": \\\"443\\\" }} ], \\\"5671/tcp\\\": [ {{ \\\"HostPort\\\": \\\"5671\\\"  }}] }} }}}}\"}},\"env\":{{\"OptimizeForPerformance\":{{\"value\":\"false\"}},\"mqttSettings__enabled\":{{\"value\":\"false\"}},\"AuthenticationMode\":{{\"value\":\"CloudAndScope\"}},\"NestedEdgeEnabled\":{{\"value\":\"false\"}}}},\"status\":\"running\",\"restartPolicy\":\"always\"}}}},\"modules\":{{\"LoRaWanNetworkSrvModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"russellgm/lorawannetworksrvmodule:{LoRaVersion}\",\"createOptions\":\"{{\\\"ExposedPorts\\\": {{ \\\"5000/tcp\\\": {{}}}}, \\\"HostConfig\\\": {{  \\\"PortBindings\\\": {{\\\"5000/tcp\\\": [  {{ \\\"HostPort\\\": \\\"5000\\\", \\\"HostIp\\\":\\\"172.17.0.1\\\" }} ]}}}}}}\"}},\"version\":\"1.0\",\"env\":{{\"ENABLE_GATEWAY\":{{\"value\":\"true\"}},\"LOG_LEVEL\":{{\"value\":\"2\"}}}},\"status\":\"running\",\"restartPolicy\":\"always\"}},\"universaldecodermodule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"docker.io/russellgm/universaldecoder:1.0-arm64\",\"createOptions\":\"{{}}\"}},\"version\":\"1.0\",\"status\":\"running\",\"restartPolicy\":\"always\"}},\"LoRaBasicsStationModule\":{{\"type\":\"docker\",\"settings\":{{\"image\":\"loraedge/lorabasicsstationmodule:{LoRaVersion}\",\"createOptions\":\"  {{\\\"HostConfig\\\": {{\\\"NetworkMode\\\": \\\"host\\\", \\\"Privileged\\\": true }},  \\\"NetworkingConfig\\\": {{\\\"EndpointsConfig\\\": {{\\\"host\\\": {{}} }}}}}}\"}},\"env\":{{\"RESET_PIN\":{{\"value\":\"{resetPin}\"}},\"TC_URI\":{{\"value\":\"ws://172.17.0.1:5000\"}}}},\"version\":\"1.0\",\"status\":\"running\",\"restartPolicy\":\"always\"}}}}}}}},\"$edgeHub\":{{\"properties.desired\":{{\"schemaVersion\":\"1.0\",\"routes\":{{\"route\":\"FROM /* INTO $upstream\"}},\"storeAndForwardConfiguration\":{{\"timeToLiveSecs\":7200}}}}}},\"LoRaWanNetworkSrvModule\":{{\"properties.desired\":{{\"DeviceManagerServicesUrl\":\"{deviceManagerServicesUrl}\",\"DeviceManagerServicesCode\":\"{deviceManagerServicesCode}\",\"hostAddress\":\"{lnsHostAddress}\",\"network\":\"{NetworkName}\"}}}}}},\"moduleContent\":{{}},\"deviceContent\":{{}}}}";
            Assert.Equal(expectedConfigurationJson, actualConfigurationJson);
        }
        ...
        public async Task DeployEdgeDeviceSettingLogAnalyticsWorkspaceShouldDeployIotHubMetricsCollectorModule()
        {
            ...
            // Act
            var args = CreateArgs($"add-gateway --reset-pin {resetPin} --device-id {deviceId} --devicemanagerservices-url {deviceManagerServicesUrl} --devicemanagerservices-code {deviceManagerServicesCode} --lns-host-address {lnsHostAddress} --network {NetworkName} --monitoring true --iothub-resource-id {iothubResourceId} --log-analytics-workspace-id {logAnalyticsWorkspaceId} --log-analytics-shared-key {logAnalyticsWorkspaceKey} --lora-version {LoRaVersion}");
            var actual = await Program.Run(args, this.configurationHelper);
